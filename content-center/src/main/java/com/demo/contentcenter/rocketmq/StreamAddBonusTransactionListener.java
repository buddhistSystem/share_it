...
/**
 * 使用stream编程重构发送mq消息
 * txProducerGroup = "stream-add-bonus-group" 必须和配置文件中指定的一样
 */
@RocketMQTransactionListener(txProducerGroup = "stream-add-bonus-group")
public class StreamAddBonusTransactionListener implements RocketMQLocalTransactionListener {
